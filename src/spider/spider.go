...
const (
	VISTIS_TIME_DISTANCE      int = 2000
	DOWNLOAD_TIME_DISTANCE    int = 2000
	RE_VISTIS_TIME_DISTANCE   int = 5000
	RE_DOWNLOAD_TIME_DISTANCE int = 5000
)
...
func (spider *Spider) StartLoopSpider() {
	...
	for {
		...
		sglog.Info(spider.cfg.Title, " data collection now in sleep,will run after ", sleepTime, "s,", nowTime.Add(timeInt), ",downlist:", len(downlist), ",revist:", len(revisitlist))
